...
//     // You can access the updated appointDate directly from the provider if needed
//     // For example:
//     appointDate = serviceProvider.appointDate;
//   }
  ...
  Future<void> getAppointmentList() async {
    ...
    setState(() {
      _appointmentDates = serviceProvider.appointDate.map((saveDate) {
        return DateFormat('dd/MM/yyyy').parse(saveDate.date);
      }).toList();
    });
  }
