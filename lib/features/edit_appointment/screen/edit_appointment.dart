...
class EditAppointment extends StatefulWidget {
  final int index;
  final OrderModel orderModer;
  final UserModel userModel;
  final SalonModel salonModel;
  const EditAppointment({
    super.key,
    required this.index,
    required this.orderModer,
...
//Serching  Services base on service name and code
  ...
  getData() async {
    ...
    try {
      // bookingProvider.getWatchList.addAll(widget.orderModer.services);
      ...
      _appointmentDateController.text = widget.orderModer.serviceDate;
      _mobileController.text = widget.userModel.phone.toString();

      if (widget.orderModer.userNote.length >= 3) {
        _userNote.text = widget.orderModer.userNote;
      }
  ...
  void addBookingServiceToWatchList() {
    ...
    timeDateList.addAll(widget.orderModer.timeDateList);
                                                    ...
                                                    ontap: () async {
                                                      ...
                                                      TimeDateModel
                                                        ...
                                                        time: GlobalVariable
                                                            .getCurrentTime(),
                                                        updateBy:
                                                            "${widget.salonModel.name} (Appointment update)",
                                                      );
                                                      timeDateList
                                                          .add(timeDateModel);
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        SizedBox(
                                                                            height:
                                                                                Dimensions.dimenisonNo20),
                                                                        Text(
                                                                          'Appointment No : ${widget.orderModer.appointmentNo}',
                                                                          style:
                                                                              TextStyle(
                                                                            fontSize:
